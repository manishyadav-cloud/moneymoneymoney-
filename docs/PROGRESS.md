...
### Group B — PG Transactions (3 tables) ✅ DONE
...
### Group C — PG Settlements (2 combined tables) ✅ DONE
...
### Group D — Refunds (1 combined table) ✅ DONE
...
- [x] Generate draft data dictionary with column definitions → `docs/DATA_DICTIONARY_DRAFT.csv`
